...
<body>
	...
	<?php
		...
		$result = $conn->query("Select * from nani_bank_add_accounts where my_account_number=$acc_num");
		$result1 = $conn->query("select * from nani_bank_users where account_number = $acc_num");
					...
					<table>
						...
						<tr>
							...
							<td>
									...
									<input type="text" name="acount_number_to" value =" <?php echo $user['account_number']; ?> " readonly>
							</td>
						</tr>
						<tr>
							<td>Amount :</td>
